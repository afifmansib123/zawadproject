        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              ...
              <div className="mt-[30px] lg:mt-[70px] flex flex-col md:flex-row lg:items-center gap-5 lg:gap-[30px]">
                <div>
                  ...
                  <span className="w-[100px] h-2 rounded-full bg-yellowColor block mt-[-14px]" style={{color : "yellow"}}></span>
            ...
            <div className="flex gap-[30px] justify-end">
              <div>
                <img className="w-full" src="/images/hero-Img01.png" alt="hero_img" />
              </div>
              <div className="mt-[30px]">
                <img
                  ...
                  alt="hero_img"
                />
                <img className="w-full" src="/images/hero-Img03.png" alt="hero_img" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="flex justify-between items-center flex-col lg:flex-row">
            ...
            <div className="relative z-10  xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              <img src="/images/feature-img.png" className="w-3/4" alt="about_img" />
